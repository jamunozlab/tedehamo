...
temp = 1300 # K, value for naming outputs
...
for comp in compositions:
    ...
    sub_directory = 'Fe{}V{}'.format((1-comp), comp)
    ...
    entropy = conf_entropy_calculation(comp)
    row_output.append(entropy)
...
df_output = df_output.rename_axis("composition")
