...
vanadium composition needs to be manually input at the beginning of the code 
...
simulation_1 = pd.read_excel('Lattice vs Energy Fe{}V{} - 500 timesteps.xlsx'.format(fe_composition, composition))
simulation_2 = pd.read_excel('Lattice vs Energy Fe{}V{} - 1000 timesteps.xlsx'.format(fe_composition, composition))
...
plt.title('Fe{}V{} Random 500K Birch-Murnaghan'.format(fe_composition, composition))
